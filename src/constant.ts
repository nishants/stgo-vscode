...
export const TFS_REPO_ID = "de3a9280-eeb1-4d1f-b391-956cb5eee690";
...
export const getCreatePullRequestUrl = (branchName: string) =>
  CREATE_PR_URL.replace("<source-branch-name>", encodeURIComponent(branchName));

const OPEN_PR_URL = `http://tfs:8080/tfs/DefaultCollection/_git/SaxoTrader/pullrequest/<pull-request-id>`;
export const getPullRequestUrl = (pullRequestId: string) =>
  OPEN_PR_URL.replace("<pull-request-id>", pullRequestId);
