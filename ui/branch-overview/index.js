...
class Index extends React.Component {
  ...
  render() {
    ...
    var createdByImage = branchData.data.createdBy._links.avatar.href;
    var formattedDate = String(branchData.data.creationDate).substring(0, 10);
          ...
          (<React.Fragment>
            ...
            <div className='row'>
              ...
              <img className="icon" src={createdByImage} /> <span className="value">
                {branchData.data.createdBy.displayName} on {formattedDate}</span>
            </div>
            <div className='row'>
              <span className="label">Reviewers :</span>
              <img className="icon" src={branchData.data.reviewers[0].imageUrl} /> <span className="value">
                {branchData.data.reviewers[0].displayName}</span>
            </div>
            <div className='row'>
