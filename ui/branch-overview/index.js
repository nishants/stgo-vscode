        ...
        return (
            <div className="branch-details">
                ...
                {existing && (
                    <React.Fragment>
                        ...
                        <div className="row">
                            ...
                            <span className="value">
                                {branchData.data.title}
                            </span>
                        </div>
                        <div className="row">
                            <span className="label">Description :</span>
                            <span className="value">
                                {branchData.data.description}
                            </span>
                        </div>
                        <div className="row">
                ...
                <div className="row no-label">
                    <div>
                        <a
                            href={`https://stestr1-nl2.tst2.dom/${selectedBranch}`}
                        >
                            Open branch on DTE
                        </a>
                    </div>
                    <div>
                        <a
                            href={`https://ba.orange.saxobank.com/${selectedBranch}`}
                        >
                ...
                {existing ? (
                    <div className="row no-label">
                        <button
                            className="button"
                            onClick={() => this.props.openUrl(branchData.link)}
                        >
                            Open Pull Request
                        </button>
                    </div>
