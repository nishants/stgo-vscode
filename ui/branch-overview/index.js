...
class Index extends React.Component {
  ...
  render() {
    ...
    var sourceRefName =
      existing && branchPullRequest.sourceRefName.split("/")[2];
    var targetRefName =
      existing && branchPullRequest.targetRefName.split("/")[2];
    ...
    return (
      <div className="branch-details">
        ...
        <div className="row no-label">
          <div>
            <a href={`https://stestr1-nl2.tst2.dom/${selectedBranch}`}>
              Open branch on DTE
            </a>
          </div>
          <div>
            <a href={`https://ba.orange.saxobank.com/${selectedBranch}`}>
              Open branch on Tst56
            </a>
          </div>
        </div>
        ...
        <div className="row no-label">
          <button
            className="button"
            onClick={() => this.props.openUrl(pullRequestUrl)}
          >
